...
var ReturnPage = (function () {
    ...
    ReturnPage.prototype.submitPhotos = function () {
        ...
        var p = this.http.post('https://taxmobileapp.com/zxing-commandline/barcode.php', { imgData: this.uploadbase64Image, project_id: 127 }, options)
...
ReturnPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://taxmobileapp.com/apptemplate/return/127'
    }),
...
AgreementPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://taxmobileapp.com/apptemplate/agreement/127'
    }),
...
var AppointmentPage = (function () {
    function AppointmentPage(navCtrl, http, sanitizer) {
        ...
        var projects = this.http.get('https://taxmobileapp.com/account/project/appointment_url/127');
        projects
...
AppointmentPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://taxmobileapp.com/apptemplate/appointment/127'
    }),
...
var StaffPage = (function () {
    function StaffPage(navCtrl, http) {
        ...
        this.http = http;
        this.staff_items = [];
        var staff = this.http.get('https://taxmobileapp.com/account/project/appstaff/127');
        staff
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
StaffPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-staff',
        templateUrl: 'https://taxmobileapp.com/apptemplate/staff/127'
    }),
...
var ContactPage = (function () {
    function ContactPage(navCtrl, http, plt, iab) {
        ...
        var locations = this.http.get('https://taxmobileapp.com/account/project/applocations/127');
        locations
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
ContactPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://taxmobileapp.com/apptemplate/contact/127'
    }),
...
var PhotosPage = (function () {
    ...
    PhotosPage.prototype.submitPhotos = function (img_name) {
        ...
        var options = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["d" /* RequestOptions */]({ headers: headers });
        //console.log(options);
        var p = this.http.post('https://taxmobileapp.com/account/project/submitreturnimages', { imgData: this.uploadbase64Image, img_name: img_name, user_id: this.user_id, project_id: 127 }, options)
            .toPromise()
            .then(function (data) {
            //this.presentSuccess();
            //alert(data);
...
PhotosPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://taxmobileapp.com/apptemplate/photos/127'
    }),
...
var CompanyPage = (function () {
    function CompanyPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        var projects = this.http.get('https://taxmobileapp.com/account/project/company_url/127');
        projects
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
CompanyPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-company',template:/*ion-inline-start:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/127/utax-ionic-template/src/pages/company/company.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>{{"Company"|translate}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    &nbsp;\n\n</ion-content>\n\n'/*ion-inline-end:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/127/utax-ionic-template/src/pages/company/company.html"*/
    }),
...
var TwitterPage = (function () {
    function TwitterPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        var projects = this.http.get('https://taxmobileapp.com/account/project/twitter_url/127');
        projects
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
TwitterPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-twitter',template:/*ion-inline-start:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/127/utax-ionic-template/src/pages/twitter/twitter.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>{{"Twitter"|translate}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    &nbsp;\n\n</ion-content>\n\n'/*ion-inline-end:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/127/utax-ionic-template/src/pages/twitter/twitter.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* Http */]])
], TwitterPage);
...
var FacebookPage = (function () {
    function FacebookPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        var projects = this.http.get('https://taxmobileapp.com/account/project/facebook_url/127');
        projects
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
FacebookPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-facebook',template:/*ion-inline-start:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/127/utax-ionic-template/src/pages/facebook/facebook.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>{{"Facebook"|translate}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    &nbsp;\n\n</ion-content>\n\n'/*ion-inline-end:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/127/utax-ionic-template/src/pages/facebook/facebook.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* Http */]])
], FacebookPage);
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        templateUrl: 'https://taxmobileapp.com/apptemplate/app/127'
    }),
...
HomePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-home',
        templateUrl: 'https://taxmobileapp.com/apptemplate/home/127'
    }),
